...
public extension ServerPacketMojang.Login {
    ...
    struct EncryptionResponse : ServerPacketMojangLoginProtocol {
        public static let id:ServerPacketMojangLogin = ServerPacketMojangLogin.encryption_response
        
        public static func parse(_ packet: GeneralPacketMojang) throws -> Self {
            let shared_secret_length:VariableInteger = try packet.read_var_int()
