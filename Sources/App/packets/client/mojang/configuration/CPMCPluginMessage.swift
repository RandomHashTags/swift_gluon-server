...
public extension ClientPacketMojang.Configuration {
    ...
    struct PluginMessage : ClientPacketMojangConfigurationProtocol {
        public static let id:ClientPacketMojangConfiguration = ClientPacketMojangConfiguration.plugin_message
