...
public extension ClientPacketMojang.Configuration {
    ...
    struct KeepAlive : ClientPacketMojangConfigurationProtocol {
        public static let id:ClientPacketMojangConfiguration = ClientPacketMojangConfiguration.keep_alive
